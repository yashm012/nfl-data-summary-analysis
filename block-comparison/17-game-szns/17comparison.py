...
reg_season_24 = dataset24[dataset24['game_id'] <= 272]
playoff_24 = dataset24[dataset24['game_id'] >= 273]
...
# Create subplots; 21-24_rs_ppg_HvA.png
...
# Create subplots for spread countplots; 21-24_spread_distr.png
fig, axes = plt.subplots(1, 4, figsize=(15, 5))
